    ...
    <>
      ...
      <div className='flex-col md:flex'>
        <div className='flex-1 space-y-4 px-4 py-6'>
          <div className='flex items-start justify-between space-y-2 flex-col lg:flex-row'>
          ...
          <Tabs defaultValue='overview' className='space-y-4'>
                  ...
                  <CardContent>
                    <div className='space-y-8'>
                      <div className='flex items-center'>
                        <div className='ml-4 space-y-1'>
                          <p className='text-sm font-medium leading-none'>
                            Ad 1: Anuncio de ventas
                          </p>
                          <p className='text-sm text-muted-foreground'>
                            Impresiones: 10,000 | Clics: 250 | Tasa de Clics
                            (CTR): 2.5% | Costo por Clic (CPC): 500
                          </p>
                        </div>
                      ...
                      <div className='flex items-center'>
                        <div className='ml-4 space-y-1'>
                          <p className='text-sm font-medium leading-none'>
                            Ad 2: Anuncio de ventas
                          </p>
                          <p className='text-sm text-muted-foreground'>
                            Impresiones: 8,000 | Clics: 256 | Tasa de Clics
                            (CTR): 3.2% | Costo por Clic (CPC): 450
                          </p>
                        </div>
                      ...
                      <div className='flex items-center'>
                        <div className='ml-4 space-y-1'>
                          <p className='text-sm font-medium leading-none'>
                            Ad 3: Anuncio de ventas
                          </p>
                          <p className='text-sm text-muted-foreground'>
                            Impresiones: 7,000 | Clics: 196 | Tasa de Clics
                            (CTR): 2.8% | Costo por Clic (CPC): 400
                          </p>
                        </div>
            ...
            <TabsContent value='devices' className='space-y-4 '>
              <div className='m-auto flex  flex-col items-center justify-center gap-2 '>
                <IconDevices size={72} color='gray' />
